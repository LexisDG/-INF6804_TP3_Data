...
la tasse 1 (en noir) est dans le rectangle définit par les deux points <x,y> [32,45] et [65,112], 
et que la tasse 2 (en rouge) est dans le rectangle définit par les deux points <x,y> [18,30] et [42,75], 
alors la sortie pour la ligne équivalente dans 'results.txt' sera:
